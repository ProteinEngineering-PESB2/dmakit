...
featureClass = sys.argv[8]
optionNormalize = int(sys.argv[9])

print (params)

#hacemos la instancia del obeto...
execProcess = execAlgorithm.execAlgorithm(dataSet, user, job, pathResponse, algorithm, params, validation, featureClass, optionNormalize)
